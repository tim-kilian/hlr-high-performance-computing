 ...
 * - For instance: Rank 2 has four lines 0-3 but only calculates 1-2 because 0 and 3 are halo lines for
 *   other processes. It is responsible for (global) lines 5-6.
 */
static
void
